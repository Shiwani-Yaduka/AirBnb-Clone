...
// maplibre-gl@6+ dropped the default export the upstream mapcn component was
// written against — a namespace import exposes the same named members as
// MapLibreGL.Map / MapLibreGL.Marker / etc. without touching call sites below.
